...
if __name__ == "__main__":
    ...
    # solution = {'grid_size': 111, 'crossing_number': 11, 'pos_list': [[76, 81], [37, 87], [63, 54], [66, 42], [44, 49], [48, 66], [51, 59], [52, 51], [59, 51], [85, 84], [49, 81]], 'direction_list': [1, 1, 1, 0, 2, 0, 2, 0, 0, 2, 3], 'pd_code': [[6, 1, 7, 2], [3, 13, 4, 12], [7, 21, 8, 20], [19, 5, 20, 10], [13, 19, 14, 22], [21, 11, 22, 18], [17, 15, 18, 14], [9, 17, 10, 16], [15, 9, 16, 8], [2, 5, 3, 6], [11, 1, 12, 4]]}
    # solution = {'grid_size': 111, 'crossing_number': 11, 'pos_list': [[76, 81], [46, 95], [63, 54], [66, 42], [44, 49], [48, 66], [51, 59], [52, 51], [59, 51], [85, 81], [49, 81]], 'direction_list': [1, 0, 1, 0, 2, 0, 2, 0, 0, 3, 3], 'pd_code': [[6, 1, 7, 2], [3, 13, 4, 12], [7, 21, 8, 20], [19, 5, 20, 10], [13, 19, 14, 22], [21, 11, 22, 18], [17, 15, 18, 14], [9, 17, 10, 16], [15, 9, 16, 8], [2, 5, 3, 6], [11, 1, 12, 4]]}
    solution = eval(input("solution>>>"))
